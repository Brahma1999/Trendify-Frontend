...
export default function AdminProductDetail() {
    ...
    //     delete newItem.id; // Removing 'id' property from newItem object
    //     dispatch(AddToCartAsync(newItem)); // Passing newItem directly, not within another object
    // }
                            ...
                            <div className="lg:col-span-1">
                                <div className="mx-auto max-w-2xl pb-0 pt-0 lg:max-w-none lg:pb-24 lg:pt-0">
                                    ...
                                    <div className="mt-4 lg:mt-0">
                                        ...
                                        <form className="mt-5">
                                            ...
                                            <button
                                                onClick={handleCart}
                                                type="submit"
                                                className="mt-10 flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-8 py-3 text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                                            >
                                                Add to Cart
                                            </button> */}
                                        </form>
                                    ...
                                    <div className="py-10 lg:border-r lg:border-gray-200 lg:pb-16 lg:pr-8 lg:pt-6">
                                        ...
                                        {product.deleted && <div className="mt-10">
                                            <h2 className="text-sm font-medium text-red-500">Product Deleted</h2>
                                        </div>}
