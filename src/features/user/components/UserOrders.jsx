    ...
    return (
        <>
            <div className='mx-auto mt-4 bg-white max-w-7xl px-4 sm:px-6 lg:px-8'>
                <h1 className="text-4xl mx-5 font-bold tracking-tight text-gray-800">My Orders</h1>
                {orders && orders.length > 0 ? orders.map((order) => (
                    <div key={order.id}>
                        <div>
                            <div className="mx-auto mt-4 bg-white max-w-7xl px-4 sm:px-6 lg:px-8">
                                <div className="border-t border-gray-100 px-4 py-4 sm:px-6">
                                    <h1 className="text-4xl my-5 font-bold tracking-tight text-gray-700">
                                        Order # {order.id}
                                    </h1>
                                ...
                                <div className="border-t border-gray-200 px-4 py-6 sm:px-6">
                                    ...
                                    {order.selectedAddress ? (
                                        <div className="flex justify-between gap-x-6 mt-2 px-5 py-5 border-solid border-2 border-gray-200">
